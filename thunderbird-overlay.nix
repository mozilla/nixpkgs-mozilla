...
let
    ...
    if release then
      ...
      let
        dir =
          ...
          else "https://download.cdn.mozilla.net/pub/thunderbird/nightly/${yearOf timestamp}/${monthOf timestamp}/${timestamp}-mozilla-central" ;
        file = "thunderbird-${version}.en-US.${system}.tar.bz2";
  ...
  thunderbirdVariants = {
    thunderbird-daily-bin = {
      name = "Thunderbird Daily";
      channel = "nightly";
      wmClass = "thunderbird-daily";
